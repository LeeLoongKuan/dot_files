;;; init-haskell.el --- Configures haskell-mode and how emacs behaves with haskell code


;;; Commentary:
;; Configuration file to configure haskell code editing
;; Implements: Configuration to haskell-mode.


;;; Code:
;; Load structured-haskell-mode (disabled for now as it does not play nice with evil-mode)
;(add-to-list 'load-path "~/.emacs.d/elisp/structured-haskell-mode/elisp")
;(require 'shm)
;(add-hook 'haskell-mode-hook 'structured-haskell-mode)

;; Use haskell-indentation for indentation
